...
namespace Model
{
    ...
    public class Model_Game
    {
        ...
        {
            $"Thanks for coming in. It's been slow lately. But this little game seems to be attracting people. If you can beat me in three rounds, you get all your food for free. I'll go easy mode the first round, I promise. Each card has its own mode that makes it unique, I'll explain.",
        ...
        public bool IsRoundOver(int turnCounter){
            ...
            if(isRoundOver)
            {
                ...
                if(RoundCounter == 2)
                {
                    main.Instance.DS.QueueMessage(true, $"So you probably thought: \"Huh, two weird people come in talking about mode, I guess that's why he calls its the mode of '87'\". But there's more... We'd agree wednesday is the third day of the week, right? Well, on the third Wednesday of March in '87, these triplets come strolling in at 3:33pm hootin and howlerin about how they just won the lottery. Next thing you know this drifter, same guy I was talking about earlier, stops eating his burger after the third bite and pulls out a triple barreled sawed off shotgun and he says to them: \"Easy mode or hard mode, doesn't matter to me. Either way I'm getting that lotto.\"... Anyways, your meal's on the house. Thanks for playing!");
                }
                else
                {
                    main.Instance.DS.QueueMessage(true, $"That was a good round. Ready for another?");
                }
