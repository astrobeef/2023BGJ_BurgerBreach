...
namespace Model
{
    ...
    public class Model_Game
    {
        ...
        {
            $"Thanks for coming in. It's been slow lately. But this little game seems to be attracting people. If you can beat me in three rounds, you get all your food for free. I'll go easy mode the first round, I promise.",
